...
B = cv2.imread(os.path.dirname(os.path.abspath(__file__))+"/73599.jpg")
A= cv2.imread(os.path.dirname(os.path.abspath(__file__))+"/boy1.jpg")
...
polygon = np.array([[100,226], [209,225], [320,100], [170,30], [70,100]], np.int32)
