...
res = cv2.matchTemplate(img,temp_img,cv2.TM_SQDIFF)### Return the matching area using matchTemplate specified SSD as similarity measure and store it to res (cv2.TM_CCOEFF_NORMEDでいいのかわからない)###
min_val, max_val, min_loc, max_loc = cv2.minMaxLoc(res)

top_left = min_loc### Return the top left coordinate to top_left ###
