...
def load_texture():
    ...
    for i in range(w):
        for j in range(h):
            data[i][h - 1 - j] = rgb_im.getpixel((i,j))
...
def draw_texture_cubic(x, y, z, length):
    ...
    ## Specify the texture coordinate of the texture using glTexCoord2f ##
    ## Specify the world coordinate of the quadrangle using glVertex3f and length ##
